...
class AnchorHeadSingle(AnchorHeadTemplate):
    ...
    def forward(self, data_dict):
        ...
        if self.training:
            ...
            ###############################################################
            if (int(data_dict["mode"][0])==1) or (int(data_dict["mode"][0])==2):
                targets_dict['pred_hm'] = data_dict['pred_hm']
                targets_dict['gt_hm'] = data_dict['points_hm']
            
            elif (int(data_dict["mode"][0])==0) or (int(data_dict["mode"][0])==3) or (int(data_dict["mode"][0])==4):
                targets_dict['pred_hm'] = torch.zeros(1, 1)
                targets_dict['gt_hm'] = torch.zeros(1, 1)
            else:
