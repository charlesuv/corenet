...
class Detector3DTemplate_seg_detect(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = [
            'vfe', 'backbone_3d_seg', 'backbone_3d', 'map_to_bev_module', 'pfe',
    ...
    def build_backbone_3d_seg(self, model_info_dict):
        if self.model_cfg.get('BACKBONE_3D_seg', None) is None:
            return None, model_info_dict

        backbone_3d_module = backbones_3d.__all__[self.model_cfg.BACKBONE_3D_seg.NAME](
            model_cfg=self.model_cfg.BACKBONE_3D_seg,
            input_channels=model_info_dict['num_point_features'],
            grid_size=model_info_dict['grid_size'],
            voxel_size=model_info_dict['voxel_size'],
            point_cloud_range=model_info_dict['point_cloud_range']
