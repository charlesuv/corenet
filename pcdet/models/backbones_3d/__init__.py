...
from .spconv_backbone import VoxelBackBone8x, VoxelBackBone8x_explicit, VoxelResBackBone8x, VoxelImageFusionBackBone8x
...
__all__ = {
    ...
    'VoxelBackBone8x_explicit': VoxelBackBone8x_explicit,
    'UNetV2': UNetV2,
