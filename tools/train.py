...
def parse_config():
    ...
    parser.add_argument("--cuda_device", type=str, default='3', help='CUDA_VISIBLE_DEVICES')
    ...
    parser.add_argument('--max_ckpt_save_num', type=int, default=20, help='max number of saved checkpoint')    # <= num_epochs_to_eval
...
def main():
    ...
    # freeze_list = ["backbone_3d", "backbone_2d", "dense_head", "roi_head"]
    # for name, param in model.named_parameters():
    #     if any(s in name for s in freeze_list):
